...
- [scheb/two-factor-bundle](https://github.com/scheb/two-factor-bundle) - [OUTDATED] Two-factor authentication for Symfony 2 & 3 applications 🔐. Please use the newer versions from https://github.com/scheb/2fa.
